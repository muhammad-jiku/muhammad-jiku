#!/usr/bin/env bash
# Refreshes two auto-generated sections of README.md:
...
python3 - "$projects_md" "$contributions_md" <<'PYEOF'
import re
import sys

projects_md, contributions_md = sys.argv[1], sys.argv[2]
